...
namespace SampleLogin_C
{
    ...
    {
        string expressFilename = "G:\\Visual Studio\\SampleLogin_C\\SampleLogin_C\\expressions.txt";
        string precodedFilename = "G:\\Visual Studio\\SampleLogin_C\\SampleLogin_C\\preset.txt";
        string[,] precoded;
